...
this.g=0;this.B=a;this.D=[];this.C=new g.Jy;this.A=this.o=null;this.H=(0,g.z)(this.hG,this);this.F=(0,g.z)(this.Qi,this);this.G=(0,g.z)(this.gG,this);this.J=(0,g.z)(this.rG,this);var c=0;a?(c=a.getProxyState(),3!=c&&(a.subscribe("proxyStateChange",this.Qp,this),Rta(this))):c=3;0!=c&&(b?this.Qp(c):g.ni((0,g.z)(function(){this.Qp(c)},this),0));
...
this.H=a;this.X=b;b.addEventListener("onVolumeChange",this.bl,this);b.addEventListener("onCaptionsTrackListChanged",this.zv,this);b.addEventListener("captionschanged",this.jv,this);b.addEventListener("captionssettingschanged",this.pp,this);b.addEventListener("videoplayerreset",this.Ti,this);b.addEventListener("mdxautoplaycancel",this.ks,this);this.C=!1;this.g=c;c.isDisposed();c.subscribe("proxyStateChange",this.Mv,this);c.subscribe("remotePlayerChange",this.Si,this);c.subscribe("remoteQueueChange",
this.Ti,this);c.subscribe("autoplayUpNext",this.gv,this);c.subscribe("previousNextChange",this.Jv,this);c.subscribe("nowAutoplaying",this.Cv,this);c.subscribe("autoplayDismissed",this.fv,this);this.suggestion=null;this.D=new g.sl(64);this.o=new g.Kd(this.Sw,500,this);g.J(this,this.o);this.A=new g.Kd(this.Tw,1E3,this);g.J(this,this.A);this.B={};this.G=new g.Kd(this.fx,1E3,this);g.J(this,this.G);this.F=new g.kw(this.rN,1E3,this);g.J(this,this.F);this.J=g.w;this.pp();this.Ti();this.Si()},d$=function(a,
...
b&&(c={style:a.X.rj()},g.Yb(c,b));a.g.Mw(g$(a),c);a.B=V9(a.g).o}},i$=function(a,b){var c=a.X.ve();
c?Sta(a.g,g$(a),b,c.g,c.listId.toString()):Sta(a.g,g$(a),b);e$(a,new g.sl(1))},hua=function(a,b){if(b){var c=a.X.Hc("captions","tracklist",{wu:1});
c&&c.length?(a.X.bf("captions","track",b),a.C=!1):(a.X.Up("captions"),a.C=!0)}else a.X.bf("captions","track",{})},f$=function(a){return V9(a.g).videoId==g$(a)},g$=function(a){return a.X.getVideoData().videoId},e$=function(a,b){a.A.stop();
var c=a.D;if(b.o!=c.o||b.g!=c.g){var d=g.S(b,2);if(d!=g.S(a.D,2)){var e=a.X;(e=g.Vl(e.app,e.playerType||1))&&g.KU(e,d)}a.D=b;iua(a.H,c,b)}},j$=function(){var a=cua();
...
g.h.Ax=function(a){if(1==this.g){if(this.o){var b=V9(this),c=new window.chrome.cast.media.SeekRequest;c.currentTime=a;c.resumeState=b.ib()||3==b.g?window.chrome.cast.media.ResumeState.PLAYBACK_START:window.chrome.cast.media.ResumeState.PLAYBACK_PAUSE;this.o.seek(c,g.w,a$(this,"seekTo",{newTime:a}))}else W9(this,"seekTo",{newTime:a});Z9(this,3,a);this.aa("remotePlayerChange")}else Y9(this,g.va(this.Ax,a))};
...
g.h.Mw=function(a,b){if(1==this.g){var c=V9(this),d={videoId:a};b&&(c.o={trackName:b.name,languageCode:b.languageCode,sourceLanguageCode:b.translationLanguage?b.translationLanguage.languageCode:"",languageName:b.languageName,format:b.format,kind:b.kind},d.style=g.tf(b.style),g.Yb(d,c.o));W9(this,"setSubtitlesTrack",d);X9(this,c)}else Y9(this,g.va(this.Mw,a,b))};
g.h.Pp=function(a,b){if(1==this.g){W9(this,"setAudioTrack",{videoId:a,audioTrackId:b.Dc.id});var c=V9(this);c.audioTrackId=b.Dc.id;X9(this,c)}else Y9(this,g.va(this.Pp,a,b))};
g.h.zx=function(a,b){if(1==this.g){if(a&&b){var c=V9(this);g.Sy(c,a,b);X9(this,c)}W9(this,"previous")}else Y9(this,g.va(this.zx,a,b))};
g.h.yx=function(a,b){if(1==this.g){if(a&&b){var c=V9(this);g.Sy(c,a,b);X9(this,c)}W9(this,"next")}else Y9(this,g.va(this.yx,a,b))};
g.h.Ts=function(){1==this.g?W9(this,"dismissAutoplay"):Y9(this,this.Ts)};
...
g.h.Qp=function(a){if((a!=this.g||2==a)&&3!=this.g&&0!=a){var b=this.g;this.g=a;this.aa("proxyStateChange",b,a);if(1==a)for(;!this.C.isEmpty();)g.My(this.C).apply(this);else 3==a&&this.dispose()}};
...
var k$=[];g.h=fua.prototype;g.h.mg=function(a,b,c){var d=this.g;if(g.p(c)?c:this.o)d="https://"+this.A+this.B+this.g;return g.cg(d+a,b||{})};
g.h.Op=function(a,b,c,d){c={format:"JSON",method:"POST",context:this,timeout:5E3,withCredentials:!1,Eb:g.va(this.fL,c,!0),onError:g.va(this.eL,d),Xc:g.va(this.gL,d)};b&&(c.Ib=b,c.headers={"Content-Type":"application/x-www-form-urlencoded"});return g.Oi(a,c)};
...
g.h.R=function(){c$.M.R.call(this);this.o.stop();this.A.stop();this.J();this.X.removeEventListener("onVolumeChange",this.bl,this);this.X.removeEventListener("onCaptionsTrackListChanged",this.zv,this);this.X.removeEventListener("captionschanged",this.jv,this);this.X.removeEventListener("videoplayerreset",this.Ti,this);this.X.removeEventListener("captionssettingschanged",this.pp,this);this.X.removeEventListener("mdxautoplaycancel",this.ks,this);this.g.Ka("proxyStateChange",this.Mv,this);this.g.Ka("remotePlayerChange",
this.Si,this);this.g.Ka("remoteQueueChange",this.Ti,this);this.g.Ka("autoplayUpNext",this.gv,this);this.g.Ka("previousNextChange",this.Jv,this);this.g.Ka("nowAutoplaying",this.Cv,this);this.g.Ka("autoplayDismissed",this.fv,this);this.g=this.H=null};
g.h.Ay=function(a,b){2==this.g.g||(f$(this)?this.uD.apply(this,arguments):this.qD.apply(this,arguments))};
g.h.jv=function(a){this.Ay("control_subtitles_set_track",g.Sb(a)?null:a)};
g.h.pp=function(){var a=this.X.Hc("captions","track");g.Sb(a)||h$(this,a)};
g.h.qD=function(a,b){var c=Array.prototype.slice.call(arguments,1);switch(a){case "control_toggle_play_pause":case "control_play":case "control_pause":i$(this,this.X.getCurrentTime());break;case "control_seek":i$(this,c[0]);break;case "control_subtitles_set_track":h$(this,c[0]);break;case "control_set_audio_track":c=c[0],f$(this)&&this.g.Pp(g$(this),c)}};
g.h.uD=function(a,b){if(1081!=V9(this.g).g||"control_seek"!=a){var c=Array.prototype.slice.call(arguments,1);switch(a){case "control_toggle_play_pause":V9(this.g).ib()?this.g.pause():this.g.play();break;case "control_play":this.g.play();break;case "control_pause":this.g.pause();break;case "control_seek":this.F.Zg(c[0],c[1]);break;case "control_subtitles_set_track":h$(this,c[0]);break;case "control_set_audio_track":c=c[0],f$(this)&&this.g.Pp(g$(this),c)}}};
...
g.h.zv=function(){g.Sb(this.B)||hua(this,this.B);this.C=!1};
g.h.Mv=function(a,b){this.A.stop();2==b&&this.Tw()};
g.h.Si=function(){if(f$(this)){this.o.stop();var a=V9(this.g);switch(a.g){case 1081:e$(this,new g.sl(8));break;case 1:this.Sw();e$(this,new g.sl(8));break;case 1083:case 3:e$(this,new g.sl(9));break;case 0:e$(this,new g.sl(2));this.F.stop();d$(this,this.X.getVideoData().lengthSeconds);break;case 1082:e$(this,new g.sl(4));break;case 2:e$(this,new g.sl(4));d$(this,g.Ry(a));break;case -1:e$(this,new g.sl(64));break;case -1E3:a={errorCode:"mdx.remoteerror",message:g.P("YTP_MDX_PLAYER_ERROR")},e$(this,
new g.sl(128,a))}var a=V9(this.g).o,b=this.B;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&a.format==b.format&&a.kind==b.kind:1)||(this.B=a,hua(this,a));a=V9(this.g);-1==a.volume||Math.round(this.X.getVolume())==a.volume&&this.X.Id()==a.muted||this.G.isActive()||this.fx()}else gua(this)};
g.h.Jv=function(){this.X.Ra("mdxpreviousnextchange")};
g.h.Ti=function(){f$(this)||gua(this)};
g.h.ks=function(){this.g.Ts()};
g.h.gv=function(a){a&&(a=g.Oi("/watch_queue_ajax",{method:"GET",wc:{action_get_watch_queue_item:1,video_id:a},Eb:(0,g.z)(this.iJ,this)}))&&(this.J=(0,g.z)(a.abort,a))};
...
g.h.Cv=function(a){(0,window.isNaN)(a)||this.X.Ra("mdxnowautoplaying",a)};
g.h.fv=function(){this.X.Ra("mdxautoplaycanceled")};
g.h.rN=function(a,b){-1==V9(this.g).g?i$(this,a):b&&this.g.Ax(a)};
g.h.fx=function(){if(f$(this)){var a=V9(this.g);this.X.removeEventListener("onVolumeChange",this.bl,this);a.muted?this.X.mute():this.X.vf();this.X.setVolume(a.volume);this.X.addEventListener("onVolumeChange",this.bl,this)}};
g.h.Sw=function(){this.o.stop();if(!this.g.isDisposed()){var a=V9(this.g);a.ib()&&e$(this,new g.sl(8));d$(this,g.Ry(a));this.o.start()}};
g.h.Tw=function(){this.A.stop();this.o.stop();var a=this.g.B.getReconnectTimeout();2==this.g.g&&!(0,window.isNaN)(a)&&this.A.start()};
g.B(m$,g.iu);g.h=m$.prototype;g.h.create=function(){kua("embedded"==g.U(this.g).g);this.D.push(g.Gi("yt-remote-before-disconnect",this.dG,this));this.D.push(g.Gi("yt-remote-connection-change",this.sI,this));this.D.push(g.Gi("yt-remote-receiver-availability-change",this.Kv,this));this.D.push(g.Gi("yt-remote-auto-connect",this.qI,this));this.D.push(g.Gi("yt-remote-receiver-resumed",this.pI,this));this.Kv()};
g.h.load=function(){this.g.fn();m$.M.load.call(this);this.C=new c$(this,this.g,this.o);var a;a=(a=Kta())?a.currentTime:0;var b=R9()?new U9(y9(),void 0):null;0==a&&b&&(a=g.Ry(V9(b)));0!=a&&(this.H=a||0,this.g.Ra("progresssync",a,void 0));iua(this,this.F,this.F);g.g2(this.g.app,6)};
g.h.unload=function(){this.g.Ra("mdxautoplaycanceled");this.B=this.A;g.Eb(this.C,this.o);this.o=this.C=null;m$.M.unload.call(this);g.g2(this.g.app,5)};
g.h.R=function(){g.Hi(this.D);m$.M.R.call(this)};
g.h.uj=function(a,b){this.loaded&&this.C.Ay.apply(this.C,arguments)};
g.h.XC=function(){return this.loaded?this.C.suggestion:null};
g.h.ry=function(){return this.o?V9(this.o).L:!1};
...
g.h.TM=function(){this.o&&this.o.yx()};
g.h.UM=function(){this.o&&this.o.zx()};
...
g.h.Kv=function(){this.G=[this.A].concat(jua());var a=j$()||this.A;n$(this,a,!this.loaded);this.g.ya("onMdxReceiversChange")};
